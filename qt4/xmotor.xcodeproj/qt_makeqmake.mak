...
QMAKE    = /usr/bin/qmake
xmotor.xcodeproj/project.pbxproj: xmotor.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o xmotor.xcodeproj/project.pbxproj xmotor.pro
